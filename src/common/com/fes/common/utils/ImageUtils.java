...
public class ImageUtils {
	 ...
	 */
	public static void scale(String srcImageFile, String result, double scale, boolean flag) {
		try {
	...
	public static void scale2(String srcImageFile, String result, int width, int height, boolean bb) {
		try {
	...
	public static void main(String[] args) {
		// 1-缩放图像：
		// 方法一：按比例缩放
		// ImageUtils.scale("e:/1.jpg", "e:/3_scale.jpg", 1.5, true); //测试OK

		// 方法二：按高度和宽度缩放,如果不补白的话缩放宽度和高度只能小于原图宽高
		// ImageUtils.scale2("e:/1.jpg", "e:/5_scale2.jpg", 300, 200, false);
		// //测试OK

		// 2-切割图像：
		// 方法一：按指定起点坐标和宽高切割
		// ImageUtils.cut("e:/b.jpg", "e:/b_cut.jpg", 100, 100, 100, 100);
		// //测试OK

		// 方法二：指定切片的行数和列数
		// ImageUtils.cut2("e:/b.jpg", "e:/", 2, 2); //测试OK

		// 方法三：指定切片的宽度和高度
		// ImageUtils.cut3("e:/1.jpg", "e:/", 100, 100);//测试OK

		// 3-图像类型转换：
		// ImageUtils.convert("e:/1.jpg", "GIF", "e:/1_convert.gif");//测试OK

		// 4-彩色转黑白：
		// ImageUtils.gray("e:/1.jpg", "e:/1_gray.jpg");//测试OK

		// 5-给图片添加文字水印：
		// 方法一：
		// ImageUtils.pressText("我是水印文字", "e:/1.jpg", "e:/1_pressText.jpg",
		// "宋体", Font.BOLD, Color.white, 20, 0, 0, 0.5f);//测试OK

		// 方法二：
		ImageUtils.pressText2("我也是水印文字", "e:/1.jpg", "e:/1_pressText2.jpg", "黑体", 36, Color.white, 20, 0, 0, 0.5f);// 测试OK

		// 6-给图片添加图片水印：
		// ImageUtils.pressImage("e:/pressimg.png", "e:/1.jpg",
		// "e:/1_pressImage.jpg", 0, 0, 0.5f); //测试OK
	}
}
